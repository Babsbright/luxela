   ...
   */
    ...
    */
    public async createSeller(payload: Partial<ISeller>): Promise<any> {
        try {
            ...
            throw new CustomAPIError(`Failed to create seller account: ${error.message}`, 500);
        }
    }
   ...
   public async getUserByMail(email: string): Promise<any> {
        try {
            ...
            throw new CustomAPIError(`Failed to fetch user data: ${error.message}`, 500);
        }
    }
    ...
    */
    public async checkExist(email: string): Promise<any> {
        try {
            ...
            throw new CustomAPIError(`Failed to check if user exist: ${error.message}`, 500);
        }
    }
