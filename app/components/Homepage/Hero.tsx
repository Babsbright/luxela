...
const MiddleSVG = () => (
  ...
  >
    <path
      d="M2 2L24.9016 15.1684C29.2864 17.6897 34.6902 17.6498 39.0373 15.064L61 2"
      stroke="url(#paint0_linear_402_1996)"
      strokeWidth="4"
      strokeLinecap="round"
    />
    <path
      d="M3 14.75L25.9016 27.9184C30.2864 30.4397 35.6902 30.3998 40.0373 27.814L62 14.75"
      stroke="url(#paint1_linear_402_1996)"
      strokeWidth="4"
      strokeLinecap="round"
    />
    <defs>
      <linearGradient
        id="paint0_linear_402_1996"
        x1="0"
        y1="10.75"
        x2="61"
        y2="10.625"
    ...
    <div className="relative min-h-screen bg-mobile-background lg:bg-hero-pattern bg-cover overflow-hidden ">
      ...
      <div className="lg:mt-[72px] mt-[44px] flex flex-col justify-center">
        ...
        <div className="mx-auto text-center mt-[24px] text-white">
          ...
          <div className="text-[15px] leading-[150%]  px-[20px] lg:hidden block font-spaceGrotesk mt-[12px]">
            <p>
              Connecting independent fashion brands to a global audience with
              transparency, sustainability, and a commitment to ethical
              practices
            </p>
          </div>
          <Link
      ...
      <div className="lg:hidden flex max-w-[393px] mx-auto gap-[10px] mt-[62px]">
        {products.slice(0, 3).map((product, index) => (
          <div
            key={index}
            className={`w-[200px] h-[250.63px] ${product.marginTop} ${
              product.marginLeft || ""
            } ${product.marginRight || ""}`}
            style={{
      ...
      <div className="mt-[56px] hidden max-w-[1440px] mx-auto lg:flex gap-[36px]">
        {Desktopproducts.map((product, index) => (
          <div
            key={index}
            className={`w-[300px] h-[375.94px] ${product.marginTop} ${
              product.marginLeft || ""
            } ${product.marginRight || ""}`}
            style={{
              marginTop: product.marginTop,
